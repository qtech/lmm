...
class LatinSinglesController extends Controller
{
    public function index()
    {
    	$songs = Songs::where(['status'=>2])->paginate(10);

    	return view('latinsingles.main')->with('songs',$songs);
    }

    public function add()
    {
    	return view('latinsingles.create');
    }
    ...
    public function store(Request $request)
    {
    	...
    	if($validator->fails())
    	{
    		return redirect()->route('latin.add')->withErrors($validator)->withInput([
    	...
    	else
    	{
    		...
    		else
    		{
    			...
    			else
    			{
			    	...
			    	{
			    		return redirect()->route('latin.add')->with('error','Invalid song type. Only "mp3" files are allowed.');
			    	}
    			}
    		}
    		...
    		$addSongstoDB->status = 2;
    		$addSongstoDB->save();

    		return redirect()->route('latin.add')->with('success','Song successfully added.');
    	}
    }
    ...
    public function edit($id)
    {
    	...
    	return view('latinsingles.edit')->with('song',$song);
    }
    ...
    public function update(Request $request, $id)
    {
    	...
    	if($validator->fails())
    	{
    		return redirect()->route('latin.edit',['id'=>$id])->withErrors($validator)->withInput([
    				'song_name' => $request->song_name,
    				'artist_name' => $request->artist_name
    			]);
    	}
    	else
    	{
    		...
    		else
    		{
    			...
    			else
    			{
			    	...
			    	{
			    		return redirect()->route('latin.edit',['id'=>$id])->with('error','Invalid song type. Only "mp3" files are allowed.');
			    	}
    			}
    		}
    		...
    		return redirect()->route('latin.edit',['id'=>$id])->with('success','Song information successfully updated.');
    	}
    }
    ...
    public function destroy(Request $request, $id)
    {
    	...
    	return redirect()->route('latin.index')->with('success','Song successfully removed.');
