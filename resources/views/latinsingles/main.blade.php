...
@section('content')
	<div class="tbl">
		<div class="tbl-row">
			<div class="tbl-cell">
				<h3>DJ Mixes Songs</h3>				
				<small class="text-muted custom-alignment">List of all Songs.</small>
			</div>	
	...
	<table id="table-edit" class="table table-bordered table-hover">
				...
				<tbody>					
					...
					<tr style="text-align: center">
						...
						<td width="5"><a href="{{route('latin.edit',['id'=>$song->song_id])}}" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a></td>
