...
<div class="tbl">
	<div class="tbl-row">
		...
		<div class="tbl-cell tbl-cell-action">
			<a href="{{route('latin.index')}}" class="btn btn-secondary pull-right"><i class="fa fa-hand-o-left"></i> Back</a>
		</div>
	</div>
</div>

<div class="box-typical box-typical-padding">
	<form action="{{route('latin.update',['id'=>$song->song_id])}}" method="POST" enctype="multipart/form-data">
	{{csrf_field()}}	
	{{method_field('PUT')}}
