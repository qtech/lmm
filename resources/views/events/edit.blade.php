...
<div class="box-typical box-typical-padding">
	...
	<div class="form-group row">
		...
		<div class="col-sm-9">
			<p class="form-control-static"><input type="text" class="form-control maxlength-simple" id="event_title" name="event_title" placeholder="Event Title" maxlength="150" value="{{$event->title}}">
	...
	<div class="form-group row">
		...
		<div class="col-sm-9">
			<p class="form-control-static"><textarea id="new_event" name="description" class="form-control">{{$event->description}}</textarea>
			</p>
		</div>
	</div>	
	<div class="form-group row">
		...
		<div class="col-sm-9">
			<p class="form-control-static"><input type="text" name="daterange" class="form-control" value="{{$event->start}} - {{$event->end}}" />
	...
	<div class="form-group row">
		...
		<div class="col-sm-9">
			<p class="form-control-static"><input type="text" class="form-control maxlength-simple" id="event_time" name="event_time" placeholder="Event Start Time" maxlength="10" value="{{$event->time}}">
	...
	<div class="form-group row">
		...
		<div class="col-sm-9">
			<p class="form-control-static"><input type="text" class="form-control maxlength-simple" id="event_address" name="address" placeholder="Event Address" maxlength="255" value="{{$event->address}}">
