...
@section('content')
	<div class="tbl">
		<div class="tbl-row">
			<div class="tbl-cell">
				<h3>Featured Djs</h3>				
				<small class="text-muted custom-alignment">List of Featured Djs Songs.</small>
			</div>	
			<div class="tbl-cell tbl-cell-action">
				<a href="{{route('english.dj.main')}}" class="btn btn-danger pull-right"><i class="fa fa-plus"></i> Djs</a>
			</div>
			<div class="tbl-cell tbl-cell-action" style="width: 150px !important;">
				<a href="{{route('english.add')}}" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Add Songs</a>
			</div>	
		</div>
	</div>
	<table id="table-edit" class="table table-bordered table-hover">
				...
				<tbody>					
					...
					<tr style="text-align: center">
						...
						<td width="5"><a href="{{route('english.edit',['id'=>$song->song_id])}}" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a></td>
							...
							<div class="modal-dialog modal-sm">
								<div class="modal-content">
									...
									<div class="modal-footer">	
										<form action="{{route('english.delete',['id'=>$song->song_id])}}" method="POST">										
										{{csrf_field()}}
										{{method_field('DELETE')}}
