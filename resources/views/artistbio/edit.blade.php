...
<div class="tbl">
	<div class="tbl-row">
		<div class="tbl-cell">
			<h3>Edit Artist Biography Details</h3>
			<small class="text-muted custom-alignment">Please change relevant artist information.</small>
		</div>		
...
<div class="box-typical box-typical-padding">
	<form action="{{route('artists_bio.update',['id' => $artists_bio->bio_id])}}" method="POST" enctype="multipart/form-data">
	{{csrf_field()}}	
	{{method_field('PUT')}}
	{{-- <div class="form-group row">
		<label class="col-sm-3 form-control-label ajdust-label-forms">Artist Name</label>
		<div class="col-sm-9">
			<p class="form-control-static"><input type="text" class="form-control maxlength-simple" id="artist_name" name="artist_name" placeholder="Artist Name" maxlength="50" value="{{$artists_bio->artist_name}}">
			...
			<p class="form-control-static">
				<select name="album_id" class="form-control">
					...
					@foreach($artists as $artist)
						<option @if($artist->album_id == $artists_bio->album_id) selected="true" @endif value="{{$artist->album_id}}">
							{{$artist->album_name}}
						</option>
					@endforeach
				</select>
	...
	<div class="form-group row">
		...
		<div class="col-sm-9">
			<p class="form-control-static"><textarea  class="form-control summernote" name="biography">{{$artists_bio->biography}}</textarea>
	...
	<div class="form-group row">
		...
		<div class="col-sm-9">
			<p class="form-control-static"><input type="text" class="form-control maxlength-simple" id="insta_url" name="insta_url" placeholder="Artists Instagram URL" maxlength="255" value="{{$artists_bio->insta_url}}">
