...
<div class="tbl">
	<div class="tbl-row">
		<div class="tbl-cell">
			<h3>Add New Songs to this Category</h3>
			<small class="text-muted custom-alignment">Add some useful information about the songs for this category. This information will be used in the mobile apps.</small>
		</div>		
		<div class="tbl-cell tbl-cell-action">
			<a href="{{route('songs.index',['id'=>$id])}}" class="btn btn-secondary pull-right"><i class="fa fa-hand-o-left"></i> Back</a>
		</div>
	</div>
</div>
...
<div class="box-typical box-typical-padding">
	...
	{{csrf_field()}}
	<input type="hidden" name="genres_id" value="{{$id}}">
	...
	<div class="form-group row">
		...
		<div class="col-sm-9">
			<p class="form-control-static">
				...
				<a href="{{route('songs.index',['id'=>$id])}}" class="btn btn-danger"><i class="fa fa-times" aria-hidden="true"></i> Cancel</a>
			</p>
		</div>
	</div>
	</form>
