...
<div class="tbl">
	<div class="tbl-row">
		...
		<div class="tbl-cell tbl-cell-action">
			<a href="{{route('songs.index',['id'=>$song->genres_id])}}" class="btn btn-secondary pull-right"><i class="fa fa-hand-o-left"></i> Back</a>
		</div>
	</div>
</div>

<div class="box-typical box-typical-padding">
	<form action="{{route('songs.update',['id'=>$song->song_id])}}" method="POST" enctype="multipart/form-data">
	{{csrf_field()}}	
	{{method_field('PUT')}}
	...
	<div class="form-group row">
		...
		<div class="col-sm-9">
			<p class="form-control-static">
				...
				<a href="{{route('songs.index',['id'=>$song->genres_id])}}" class="btn btn-danger"><i class="fa fa-times" aria-hidden="true"></i> Cancel</a>
			</p>
		</div>
	</div>
	</form>
