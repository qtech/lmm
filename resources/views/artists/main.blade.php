...
@section('content')
	<div class="tbl">
		<div class="tbl-row">
			<div class="tbl-cell">
				<h3>Artists Songs</h3>				
				<small class="text-muted custom-alignment">List of Artists with their songs and artist in which they are added.</small>
			</div>	
			<div class="tbl-cell tbl-cell-action">
				<a href="{{route('artists.add')}}" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Add Song</a>
			</div>	
		</div>
	</div>
	<table id="table-edit" class="table table-bordered table-hover">
				...
				<tbody>					
					...
					<tr style="text-align: center">
						...
						<td width="5"><a href="{{route('artists.edit',['id'=>$song->song_id])}}" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a></td>
							...
							<div class="modal-dialog modal-sm">
								<div class="modal-content">
									...
									<div class="modal-footer">	
										<form action="{{route('artists.delete',['id'=>$song->song_id])}}" method="POST">										
										{{csrf_field()}}
										{{method_field('DELETE')}}
					...
					@empty
					<tr>
						<td colspan="9">No songs available.</td>
					</tr>
					@endforelse
				</tbody>
			</table>
