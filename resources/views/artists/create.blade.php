...
<div class="tbl">
	<div class="tbl-row">
		<div class="tbl-cell">
			<h3>Add New Featured Artist Song</h3>
...
<div class="box-typical box-typical-padding">
	...
	<div class="form-group row">
		<label class="col-sm-3 form-control-label ajdust-label-forms">Select Artist</label>
		<div class="col-sm-9">
			<p class="form-control-static">
				<select class="bootstrap-select" name="album_id">
					<option selected value="null">Select Artist</option>
	...
	<div class="form-group row">
		...
		<div class="col-sm-9">
			<p class="form-control-static">
				...
				<a href="{{route('latin.index')}}" class="btn btn-danger"><i class="fa fa-times" aria-hidden="true"></i> Cancel</a>
			</p>
		</div>
	</div>
	</form>
