...
<div class="box-typical box-typical-padding">
	<form action="{{route('videos-of-the-day.store')}}" method="POST" enctype="multipart/form-data">
	{{csrf_field()}}	
	...
	<div class="form-group row">
		...
		<div class="col-sm-9">
			<p class="form-control-static">
				...
				<a href="{{route('videos-of-the-day.index')}}" class="btn btn-danger"><i class="fa fa-times" aria-hidden="true"></i> Cancel</a>
			</p>
		</div>
	</div>
	</form>
