...
<div class="box-typical box-typical-padding">
	...
	<div class="form-group row">
		...
		<div class="col-sm-9">
			<p class="form-control-static"><input type="text" class="form-control maxlength-simple" id="album_name" name="album_name" placeholder="Artist Name" maxlength="50" value="{{old('album_name')}}">
